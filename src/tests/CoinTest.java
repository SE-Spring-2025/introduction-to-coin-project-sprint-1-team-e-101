...
public class CoinTest {
    ...
    public void testConstructors() {
        ...
        // parameterless constructor: using Penny as the default coin
        try {
        ...
        // value arg constructor: using Nickel for a 0.05 coin
        try {
            @SuppressWarnings("unused")
            Coin c = new Nickel();
        }
        ...
        // value and year args constructor: using Dime with specified year
        try {
            @SuppressWarnings("unused")
    ...
    public void testToString() {
        // Use the HalfDollar constructor that accepts a year.
